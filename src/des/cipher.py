...
class Cipher:
	...
	def encrypt_msg(cls, msg, hex_key):
		...
		ValueError
			If the message is empty or key is not hexadecimal or not 16 digits.
	...
	def decrypt_msg(cls, encrypted_data, hex_key):
		...
		------
		ValueError
			If the encrypted string length is not a multiple of 16 or key is not hexadecimal or not 16 digits.
